...
enum PreviewSupport {
    ...
    @MainActor static func makeModel() -> PhoneModel {
        ...
        let model = PhoneModel(initialDoNotDisturb: initialDoNotDisturb,
                               ...
                               persistReminderNotificationTiming: {
                                defaults.set($0.rawValue, forKey: reminderNotificationTimingKey)
                               },
